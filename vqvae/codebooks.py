...
if __name__ == "__main__":
    codebook = extract_codebook("../results/Inpainting Fraction = 0.25/inpainting_MNIST_0.25.pth", model)
    print(codebook.shape)
    np.save("../results/Inpainting Fraction = 0.4/codebook_inpainting_0.25.npy", codebook)
